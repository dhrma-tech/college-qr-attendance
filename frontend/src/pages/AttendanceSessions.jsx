        ...
        >
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 bg-white/50 backdrop-blur-md p-6 rounded-[32px] border border-white shadow-xl shadow-slate-200/20">
                <div className="space-y-1">
                    <h1 className="text-3xl font-black text-slate-900 tracking-tight">Live Sessions</h1>
                    <p className="text-sm font-medium text-slate-500">Manage live QR attendance sessions</p>
                </div>
                <motion.button 
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                        ...
                        >
                            ...
                            <div className="relative z-10 space-y-6">
                                ...
                                <div className="pt-4 grid grid-cols-2 gap-4 border-t border-slate-50">
                                    ...
                                    <div className="space-y-1">
                                        <p className="text-[8px] font-black text-slate-400 uppercase tracking-widest">Verified Students</p>
                                        <div className="flex items-center gap-2 text-xs font-bold text-slate-600">
                                            <Activity className="w-3.5 h-3.5 text-slate-300" />
                                            {session.verifiedCount || 0} Verified
                                        </div>
                                    </div>
                                </div>
                ...
                {sessions.length === 0 && (
                    ...
                    >
                        ...
                        <div>
                            <p className="font-black text-slate-900 tracking-tight">Ready to Start</p>
                            <p className="text-sm text-slate-400 font-medium">No attendance sessions found.</p>
                        </div>
                        <button 
